...
public class Vertex {
	...
	public void addNeighbour(Vertex vertex) { this.adjacenciesList.add(vertex); }
	...
	public List<Vertex> getAdjacenciesList() { return adjacenciesList; }

	public void setAdjacenciesList(List<Vertex> adjacenciesList) { this.adjacenciesList = adjacenciesList; }
